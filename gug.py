...
#
# 'Growing uniform grid' for low-dimensional nearest neighbor searches
# when adding points to the structure needs to be very cheap. 
# Originally described in "Growing neural gas efficiently"
#
